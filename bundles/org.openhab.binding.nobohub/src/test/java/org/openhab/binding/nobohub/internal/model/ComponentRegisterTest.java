...
public class ComponentRegisterTest {
    ...
    public void testPutGet() throws NoboDataException {
        ...
        sut.put(c);
        assertEquals(c, sut.get(c.getSerialNumber()));
    }
    ...
    public void testPutOverwrite() throws NoboDataException {
        ...
        sut.put(c1);
        sut.put(c2);
        assertEquals(c2, sut.get(c2.getSerialNumber()));
    }
    ...
    public void testValues() throws NoboDataException {
        ...
        assertEquals(true, sut.values().contains(c1));
        assertEquals(true, sut.values().contains(c2));
    }
